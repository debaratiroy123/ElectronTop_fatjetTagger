#define Anal_LeptopReco2D_PROOF_cxx
#include "Anal_LeptopReco2D_PROOF.h"
#include <TH2.h>
#include <TStyle.h>
...
void Anal_LeptopReco2D_PROOF::Begin(TTree * /*tree*/)
{
...
void Anal_LeptopReco2D_PROOF::SlaveBegin(TTree * /*tree*/)
{
...
Bool_t Anal_LeptopReco2D_PROOF::Process(Long64_t entry)
{
  // The Process() function is called for each entry in the tree (or possibly
  // keyed object in the case of PROOF) to be processed. The entry argument
  // specifies which entry in the currently loaded tree is to be processed.
  // It can be passed to either Anal_LeptopReco2D_PROOF::GetEntry() or TBranch::GetEntry()
...
void Anal_LeptopReco2D_PROOF::SlaveTerminate()
{
 ...
 void Anal_LeptopReco2D_PROOF::Terminate()
 {
