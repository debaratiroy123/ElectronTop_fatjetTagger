...
'root://cmsxrootd.fnal.gov//store/data/Run2018D/JetHT/MINIAOD/PromptReco-v2/000/320/500/00000/70B4EE06-1096-E811-953F-FA163EDD61A5.root'
   )
...
process.allMetFilterPaths=cms.Sequence(process.primaryVertexFilter*process.globalSuperTightHalo2016Filter*process.HBHENoiseFilter*process.HBHENoiseIsoFilter*process.BadPFMuonFilter);
#*process.EcalDeadCellTriggerPrimitiveFilter*process.BadPFMuonFilter);#*process.BadChargedCandidateFilter)#*process.eeBadScFilter)
