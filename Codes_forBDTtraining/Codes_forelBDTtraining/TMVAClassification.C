...
int TMVAClassification( TString myMethodList = "" )
{
  ...
  // 1-dimensional likelihood ("naive Bayes estimator")
   ...
   fname = "testeltop_thadv2_Jan2021_19UL18.root";
   TFile *inputS1 = TFile::Open( fname ); 
   
   fname = "testeltop_tsemilepv2_Jan2021_19UL18.root";
   TFile *inputS2 = TFile::Open( fname );
   
   fname = "testeltop_tdilepv2_Jan2021_19UL18.root";
   TFile *inputS3 = TFile::Open( fname );
   
   fname = "testeltop_qcd100to200lepv2_Jan2021_19UL18.root";
   TFile *inputB1 = TFile::Open( fname );
   
   fname = "testeltop_qcd200to300lepv2_Jan2021_19UL18.root";
   TFile *inputB2 = TFile::Open( fname );
   
   fname = "testeltop_qcd300to500lepv2_Jan2021_19UL18.root";   
   TFile *inputB3 = TFile::Open( fname );
   
   fname = "testeltop_qcd500to700lepv2_Jan2021_19UL18.root";   
   TFile *inputB4 = TFile::Open( fname );
   
   fname = "testeltop_qcd700to1000lepv2_Jan2021_19UL18.root";
   TFile *inputB5 = TFile::Open( fname );
   
   fname = "testeltop_qcd1000to1500lepv2_Jan2021_19UL18.root";   
   TFile *inputB6 = TFile::Open( fname );

   fname = "testeltop_qcd1500to2000lepv2_Jan2021_19UL18.root";   
   TFile *inputB7 = TFile::Open( fname );
   
   fname = "testeltop_qcd2000toInflepv2_Jan2021_19UL18.root";
   ...
   */
   ...
   TTree *signalTree1     = (TTree*)inputS1->Get("leptop_e");
   TTree *signalTree2     = (TTree*)inputS2->Get("leptop_e");
   TTree *signalTree3     = (TTree*)inputS3->Get("leptop_e");
   ...
   TString outfileName( "TMVA_JMARcommentv1ptrel.root" );
...
//   dataloader->AddSpectator( "spec2 := var1*3",  "Spectator 2", "units", 'F' );
   ...
   Double_t signalWeight1    = 6.0408e-06;
   Double_t signalWeight2    = 6.0779e-06;
   Double_t signalWeight3    = 1.9050e-05;
